...
<html lang="en">
<head>
    <title>Personal Website :: Mizanur</title>
    ...
    <!-- css files -->
    <link rel="stylesheet" href="{{asset('assets/frontend/css/bootstrap.css')}}"> <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="{{asset('assets/frontend/css/style.css')}}" type="text/css" media="all" /> <!-- Style-CSS -->
    <link rel="stylesheet" href="{{asset('assets/frontend/css/fontawesome-all.css')}}"> <!-- Font-Awesome-Icons-CSS -->
    <!-- //css files -->
        ...
        <div class="container">
            <div class="row agile_banner_info">
                <div class="col-md-7 agile_banner_margin">
                    <h5>Hi</h5>
                    <h2>My name is <span>Mizanur</span></h2>
                ...
                <div class="col-md-5 image_margin">
                    <img src="images/mizanur.jpg" alt="" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
