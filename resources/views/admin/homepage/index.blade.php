    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">List Of Homepage</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                    <li class="active">Homepage List</li>
                </ol>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Homepage List</h3>
                </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach($homepages as $homepage)
                            <tr>
                                ...
                                <td>{{ucfirst($homepage->status)}}</td>
                                <td class="text-center">
                                    <div style="max-width: 70px; max-height:70px;overflow:hidden">
                                        <img src="{{ asset($homepage->image) }}" class="img-fluid img-rounded" alt="">
                                    </div>
                                </td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('homepage.edit', $homepage->id) }}">Edit</a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('homepage.destroy', $homepage->id) }}">
                                        @csrf
                                        @method('delete')
